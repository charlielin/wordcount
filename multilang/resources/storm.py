...
def readMsg():
    ...
    while True:
        ...
        if line == "end":
            break
        msg = msg + line + "\n"
    f = open("/home/linqili/projects/RTB/trunk/StormTopo/target/err", 'a+')
    f.write(msg)
...
def initComponent():
    ...
    return [setupInfo['conf'], setupInfo['context'], setupInfo['pidDir']]
...
class Bolt:
    ...
    def run(self):
        global MODE
        MODE = Bolt
        conf, context, piddir = initComponent()
